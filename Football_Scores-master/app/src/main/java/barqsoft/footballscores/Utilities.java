...
public class Utilities
{
    ...
    public static String getLeague(final Context context, int league_num)
    {
        switch (league_num)
        {
    ...
    private static List<ContentValues> processJSONdata(String JSONdata, boolean isReal)
    {
        //JSON data
        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                ...
                {
//                    Log.i(LOG_TAG, "  found league " + League);
                    ...
                    try {
                        ...
                        Log.e(LOG_TAG, "Error while processing JSON data", e);
                        return null;
                    }
...
//                } else {
//                    Log.i(LOG_TAG, "  ignoring league " + League);
                }
            }
    ...
    public static List<ContentValues> fetchData (String timeFrame, final Context context) {
        //Creating fetch URL
        ...
        try {
            if (JSON_data != null) {
                ...
                if (matches.length() == 0) {
                    ...
                    JSON_data = context.getString(R.string.dummy_data);
                }

                return processJSONdata(JSON_data, true);
            } else {
                //Could not Connect
